...
Class MainWindow
    ...
    Private Sub InitializeEmbeddedResources()
        Dim tempDir = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "wav2bcwav_temp")
        System.IO.Directory.CreateDirectory(tempDir)

        _tempExePath = System.IO.Path.Combine(tempDir, "ctr_WaveConverter32.exe")
        ExtractEmbeddedResource("ctr_WaveConverter32.exe", _tempExePath)
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        If Not System.IO.File.Exists(_tempExePath) Then
            MessageBox.Show("无法提取ctr_WaveConverter32.exe,请确保资源已正确嵌入.", "错误", MessageBoxButton.OK, MessageBoxImage.Error)
    ...
    Private Sub rbIMAADPCM_Checked(sender As Object, e As RoutedEventArgs)
        selectedFormat = "--imaadpcm"
        selectedFormatName = "imaadpcm"
    End Sub
    ...
    Private Sub btnProcess_Click(sender As Object, e As RoutedEventArgs)
        ...
        If Not System.IO.File.Exists(_tempExePath) Then
            MessageBox.Show("找不到ctr_WaveConverter32.exe,无法进行转换.", "错误", MessageBoxButton.OK, MessageBoxImage.Error)
            Return
        End If
    ...
    Private Async Function ConvertFileAsync(inputFile As String) As Task(Of Boolean)
        Return Await Task.Run(Function()
                                  Try
                                      ...
                                      Dim outputFileName As String = fileNameWithoutExt & "." & selectedFormatName & ".bcwav"
                                      ...
                                      Using process As Process = Process.Start(processInfo)
                                          ...
                                          If process.ExitCode = 0 Then
                                              ...
                                              Dim searchPattern As String = fileNameWithoutExt & "*" & selectedFormatName & "*.bcwav"
